...
const createStyles = (theme: AppTheme) =>
  StyleSheet.create({
    ...
    purchaseScreen: { backgroundColor: '#0E0D0C', flex: 1 },
    purchaseContent: {
      paddingBottom: 24,
    ...
    billingOptionSelected: { backgroundColor: '#29251F' },
    billingOptionLabel: {
      color: '#8D857D',
      fontFamily: fonts.extraBold,
      fontSize: 14,
    ...
    billingOptionLabelSelected: { color: '#F8F2EA' },
    ...
    planCardSelected: { backgroundColor: '#242015', borderColor: theme.accent },
